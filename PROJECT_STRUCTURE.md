...
- data/
  ...
  - raw/<DATASET>/: original inputs (not produced by pipeline scripts)
  - interim/<DATASET>/: intermediate derivatives
  - processed/<DATASET>/: reusable, cleaned outputs

- outputs/
  Run artifacts (results, figures, logs). Not tracked by git.
  - <DATASET>/figures/: figures generated by pipeline scripts
  - <DATASET>/logs/: runtime logs (script logs, SLURM stdout/stderr)
  - <DATASET>/results/: results generated by pipeline scripts
  - <DATASET>/tables/: tables generated by pipeline scripts
...
- models/
  ...
  - <DATASET>/: dataset-scoped model artifacts
