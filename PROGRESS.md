...
- Replaced item sequences for answer_group2 subjects by overwriting the workbook item column with item_group1 templates (website-crash reference-subject error), and regenerated item groupings (report: `docs/reports/app_v2_item_replace_answer_group2.md`).
